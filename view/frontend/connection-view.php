...
<div class="container">
    ...
    <div ng-app="sample">
        <form class="form-horizontal" method="post" action="index.php?action=loginMember">
           ...
           <!-- <div class="g-recaptcha" data-sitekey="6LfTh2gUAAAAAAUkSq2sVzS5KwZqPbnV58b4PVGH"></div>     Local-->  
           <div class="g-recaptcha" data-sitekey="6LfFD2QUAAAAAECggMAv9gV_rLN7PryYZ_5IZWIV"></div>  <!--Local-->  
            <div class="form-group">
